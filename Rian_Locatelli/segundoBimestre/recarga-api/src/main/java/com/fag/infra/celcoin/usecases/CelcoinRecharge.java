...
import com.fag.infra.celcoin.service.RestCelcoinCliente;
...
@ApplicationScoped
public class CelcoinRecharge implements IRechargeVendor {

    @Inject
    @RestClient
    RestCelcoinCliente restCliente;
    ...
    public RechargeDTO create(RechargeDTO recharge) {
        ...
        try {
            ...
            CelcoinRechargeResponseDTO response = restCliente.handleRecharge(getToken(), rechargeDTO);
    ...
    public List<OperatorDTO> listOperators(Integer stateCode, Integer category) {
        ...
        try {
            CelcoinOperatorsDTO operators = restCliente.listOperators(getToken(), stateCode, category);
    ...
    public List<ProductDTO> listProducts(Integer operatorId, Integer stateCode) {
        try {
            CelcoinProductsDTO products = restCliente.listProducts(getToken(), stateCode, operatorId);
    ...
    private String getToken() {
        ...
        CelcoinTokenDTO tokenDTO = restCliente.generateToken(form);
